...
const MONDAY_SUBDOMAIN_API = (isNodeDevEnv && process.env.MONDAY_SUBDOMAIN_API) || "api.";
const MONDAY_API_URL = `${MONDAY_PROTOCOL}://${MONDAY_SUBDOMAIN_API}${MONDAY_DOMAIN}/v2`;
const MONDAY_OAUTH_SUBDOMAIN = (isNodeDevEnv && process.env.MONDAY_OAUTH_SUBDOMAIN) || "auth.";
